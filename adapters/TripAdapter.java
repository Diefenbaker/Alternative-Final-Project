...
public class TripAdapter extends RecyclerView.Adapter<TripAdapter.MyViewHolder> {
    ...
    public TripAdapter(Context mContext, List<Trips> tripList) {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        switch (item.getItemId()) {
                            ...
                            case R.id.action_add_trip:
                                myDatabase.child("users").child(firebaseUser.getUid()).child("saved activities").child(trips.getName()).setValue(trips);
                                Toast.makeText(mContext, "Added to Itinerary", Toast.LENGTH_SHORT).show();
                                return true;
